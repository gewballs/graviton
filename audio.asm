...
;#Data l audio.driver {
    ...
    $C4 $F7 $C4 $FA $C4 $FB $C4 $FC $8F $00 $00 $8F $08 $01 $FD $D7
    ...
    $9C $05 $FE $05 $28 $06 $E0 $03 $E0 $03 $E0 $03 $E0 $03 $E0 $03
}
...
;#Name $03 BGM_data // data 03 rr dd
;#Name $04 BGM_jump // jump 04 aaaa
;#Name $05 BGM_loop // loop 05 ll aaaa
;#Name $06 BGM_call // call 06 aaaa
;#Name $07 BGM_back // back 07
...
0228          ;        :                       | // Ram
0228 8F 00 00 ;        :MOV $00,#$00           | $00=0x0800; // End of code
022B 8F 08 01 ;        :MOV $01,#$08           |
022E FD       ;        :MOV Y,A                | Y=0;
